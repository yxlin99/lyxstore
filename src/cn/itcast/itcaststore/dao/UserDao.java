...
public class UserDao {
	...
	//修改用户信息：密码、性别、电话
	public void updateUser(String username,String password,String sex,String telephone) throws SQLException {
		
		String sql = "update user set password=? and sex=? and telephone=? where username=?";
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		runner.update(sql, password, sex,telephone,username);
	}
}
