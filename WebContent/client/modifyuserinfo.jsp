							...
							<td>
								...
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><input type="password" class="textinput" ${user.password}/></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
								...
								<p style="text-align:center">
									...
									<a href="${pageContext.request.contextPath}/EditUser?username=${user.username}&password=${user.password}&sex=${user.gender}&telepthone=${user.telephone}">
									提交
									</a>
								</p>
